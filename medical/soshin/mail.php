...
$require = array('お名前','メールアドレス','第二希望日付','第二希望日付','第二希望日付');
...
$re_subject = "クリスタルへの問い合わせありがとうございます。[和皮ふ科クリニック]";
...
この度は『ダイエット外来「クリスタル」』へのお問い合せいただき、誠にありがとうございます。
